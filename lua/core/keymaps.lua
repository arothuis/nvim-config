...
which_key.add({
  -- Global
  {
    ...
    { "grn",      function() require("nvchad.lsp.renamer")() end, desc = "Rename" },
  ...
  -- Help
  {
    ...
    { "<leader>hK", "<cmd>WhichKey<CR>",                             desc = "Show all keymaps (WhichKey)" },
    { "<leader>hQ", function() vim.cmd("WhichKey " .. vim.fn.input("WhichKey: ")) end, desc = "Query keymap" },
    { "<leader>ht", function() require("nvchad.themes").open() end,  desc = "Show themes" },
    { "<leader>hm", "<CMD>Mason<CR>",                                desc = "Show Mason" },
    { "<leader>hc", "<cmd>NvCheatsheet<CR>",                         desc = "Show cheatsheet" },
  },
  -- Search
  {
  ...
  -- Code
  {
    ...
    { "<leader>cr", function() require("nvchad.lsp.renamer")() end, desc = "Rename" },
  ...
  -- Diagnostics and messages
  {
    ...
    { "<leader>xl", vim.diagnostic.setloclist,         desc = "Diagnostics location list" },
  ...
  -- Bookmarks
  {
    ...
    { "<leader>ma", "<cmd>Telescope marks<CR>",          desc = "List marks" },
  },
  -- Terminal
  {
    ...
    { "<leader>tp", "<cmd>Telescope terms<CR>", desc = "Pick terminal" },
  },
  -- AI
  {
  },
  -- UI/UX
  {
    ...
    { "<leader>ut", function() require("nvchad.themes").open() end, desc = "Show themes" },
    {
      "<leader>un",
      function()
